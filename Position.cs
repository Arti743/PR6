    ...
    public partial class Position : Form
    {
        ...
        private void buttonSave_Click(object sender, EventArgs e)
        {
            using (SqlConnection connection = new SqlConnection(connectionString))
            {
                ...
                adap.InsertCommand.Parameters.Add(new SqlParameter("@Position_Name", SqlDbType.VarChar, 40, "Position_Name"));
                adap.InsertCommand.Parameters.Add(new SqlParameter("@Position_salary", SqlDbType.Money, 0, "Position_salary"));
